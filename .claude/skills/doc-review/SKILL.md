...
4. Smoketest: launch ROM via **PowerShell tool** using the emulator launch command in `CLAUDE.local.md` (Bash exits silently on Windows); **wait for the user to confirm it looks correct** before continuing
