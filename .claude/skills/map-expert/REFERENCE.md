# Map Expert — Reference

Full Python implementation details, GB hardware deep-dive, and Tiled format reference.
See [`SKILL.md`](SKILL.md) for the quick-reference pipeline overview and command table.
