...
typing are both owned end-to-end by `tools/factory_publish.py` (ADR 0006 (#475); `Plan` added by
#514); `PRD` by the `/prd` skill; `ADR` by the `grill-with-docs` overlay; `Epic` by hand.
