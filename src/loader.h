...
/* Copies turret spawn positions from banked ROM into caller-supplied arrays.
 * id 0 = track, 1 = track2, 2 = track3.
 * out_tx/out_ty must each be at least MAX_TURRETS bytes. */
